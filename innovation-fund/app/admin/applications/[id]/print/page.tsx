...
import { buildFilename, buildExportName, getExportPath } from "@/lib/export-settings";
...
function PrintContent() {
  ...
  // 파일 저장 경로 메뉴에 적어둔 보관 경로(메모) — 저장 대화상자에서 폴더 선택 시 참고
  const pathMemo = (doc === "payment" || doc === "review") ? getExportPath(doc) : "";
