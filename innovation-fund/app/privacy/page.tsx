...
const sections: { h: string; body: React.ReactNode }[] = [
  {
    ...
    body: (
      <ul className="list-disc pl-5 space-y-1">
        <li>회원가입: 학번, 이름, 학적유형(대학생·대학원생), 소속(대학·캠퍼스·단과대학·학과·전공), 연락처, 이메일, 본인 명의 계좌정보(은행·예금주·계좌번호)</li>
        <li>지원금 신청: 학년, 학적 상태, 신청 유형별 활동·성과 정보, 서명, (지급 시) 계좌정보</li>
  ...
  },
  {
    ...
    body: (
      <ul className="list-disc pl-5 space-y-1">
        ...
        <li><strong>국외 이전</strong>: 위 Google Drive·스프레드시트는 Google LLC(미국)가 운영하며, 보관 데이터가 국외 서버에 저장·처리될 수 있습니다. 이전 항목은 위 ‘업무용 사본’ 범위와 같고, 이전 목적은 사업 운영(서류 보관·관리)이며, 보유기간은 본 방침의 보유기간과 같습니다.</li>
